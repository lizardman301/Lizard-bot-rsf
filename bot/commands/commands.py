...
from commands.utilities import (register, bold, get_users,get_challonge_identifier, is_channel, pings_b_gone, checkin, seeding, read_db, save_db, settings_exist)
...
async def challonge(command, msg, user, channel, *args, **kwargs):
    ...
    async with channel.typing():
        ...
        try:
            ...
            tour_url = get_challonge_identifier(read_db('channel', 'bracket', channel.id)) # no bracket provided, give it one from DB
